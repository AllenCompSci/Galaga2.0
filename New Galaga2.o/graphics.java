...
public class graphics implements Runnable, KeyListener, WindowListener, MouseListener {
        ...
        private int dx4, dx5, dy4, dy5, dx2, dx3, dy2, dy9, dt,dy50,dy20,dy90,dx10,dx30;
    ...
    private void loadImages() {
        ...
        try {
            ...
            grass = ImageIO.read(this.getClass().getResource("putin.jpg"));
            pig = ImageIO.read(this.getClass().getResource("16.png"));
            dirt = ImageIO.read(this.getClass().getResource("space.jpg"));
            e = ImageIO.read(this.getClass().getResource("pranay.jpg"));
    ...
    private void draw() {
        ...
        //player
        g2d.drawImage(aashay,dx4,dy4,dx5,dy5, 0, 0, 650, 1033, null );//650,1033//dx4,dy4,dx5.dy5
        g2d.drawImage(grass,dx2, dy2, dx3, dy9,0,0,1024,1365,null);
        g2d.drawImage(e,dx10, dy20, dx30, dy90,0,0,1024,1365,null);
        g2d.setStroke(old);
        if(isRunning)
